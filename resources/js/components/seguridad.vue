        ...
        <div class="row">
          ...
          >
            ...
            >
                ...
                >
                  ...
                  <p class="text-primary mb-0" v-else>
                    <label class="btn btn-outline-primary my-0">
                      <input type="radio" name="time" value="h.time" required />
                      <span>{{ h.time }} </span>
                    </label>
                  </p>
                </v-chip-group>
              ...
              <v-card-actions>
                <v-btn class="btn btn-reservar" color="#fff" text>
                  <a
                   @click="detalles(p.pistas.name,p.date,p.horas)"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary cerrarModal" data-bs-dismiss="modal">Close</button>
...
export default {
  ...
  methods: {
    detalles(name,dia,hora){
      this.info={name,dia, hora}
